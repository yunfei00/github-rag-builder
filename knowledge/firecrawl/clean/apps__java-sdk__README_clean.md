...
owner: firecrawl
repo: firecrawl
path: apps/java-sdk/README.md
url: https://github.com/firecrawl/firecrawl/blob/main/apps/java-sdk/README.md
---
# Firecrawl Java SDK

Java SDK for Firecrawl — search, scrape, and interact with the web.
...
1. Get your API key from Firecrawl Dashboard
