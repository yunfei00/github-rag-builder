...
owner: firecrawl
repo: firecrawl
path: apps/go-sdk/README.md
url: https://github.com/firecrawl/firecrawl/blob/main/apps/go-sdk/README.md
---
# Firecrawl Go SDK

Go SDK for the Firecrawl v2 web scraping API.
...
Get your API key from the Firecrawl Dashboard and set it as an environment variable:
...
nested module tagging convention. Tags
