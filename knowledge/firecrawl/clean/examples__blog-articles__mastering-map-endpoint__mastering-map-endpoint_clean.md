...
owner: firecrawl
repo: firecrawl
path: examples/blog-articles/mastering-map-endpoint/mastering-map-endpoint.md
url: https://github.com/firecrawl/firecrawl/blob/main/examples/blog-articles/mastering-map-endpoint/mastering-map-endpoint.md
---
---
...
The next step is obtaining a Firecrawl API key by signing up at firecrawl.dev and choosing a plan (the free plan is fine for this tutorial).
...
- Required range: x ` element and adds several child elements:

- ``: Contains the actual URL
- ``: Set to today's date to indicate when the page was last modified
- ``: Set to "monthly" to suggest how often the page content changes
- ``: Set to "0.5" to indicate the relative importance of the page
...
The script that generated this plot contains more than 400 lines of code and I made it fully customizable. The code in `sitemap_generator.py` follows a modular, object-oriented approach with several key components:
...
Here is another plot generated for the PyData.org website:
