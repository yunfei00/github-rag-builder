...
owner: firecrawl
repo: firecrawl
path: examples/gemini-2.5-screenshot-editor/README.md
url: https://github.com/firecrawl/firecrawl/blob/main/examples/gemini-2.5-screenshot-editor/README.md
---
...
- **Firecrawl Issues**: firecrawl.dev/support
- **Gemini Documentation**: ai.google.dev
- **GitHub Issues**: Report bugs in the Firecrawl repository

---

Built with ❤️ for the Firecrawl community | GitHub Issue #2169
