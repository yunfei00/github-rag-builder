...
owner: firecrawl
repo: firecrawl
path: apps/rust-sdk/README.md
url: https://github.com/firecrawl/firecrawl/blob/main/apps/rust-sdk/README.md
---
# Firecrawl Rust SDK
...
First, you need to obtain an API key from firecrawl.dev. Then, you need to initialize the `Client` like so:
...
The SDK handles errors returned by the Firecrawl API and by our dependencies, and combines them into the `FirecrawlError` enum, implementing `Error`, `Debug` and `Display`. All of our methods return a `Result`.
...
The Firecrawl Rust SDK is open-source and released under the MIT License.
