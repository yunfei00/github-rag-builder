...
owner: firecrawl
repo: firecrawl
path: examples/deep-research-apartment-finder/README.md
url: https://github.com/firecrawl/firecrawl/blob/main/examples/deep-research-apartment-finder/README.md
---
...
3. Set up API keys:
   ...
   - Fill in your Firecrawl API key from firecrawl.dev
   - Fill in your Anthropic API key from console.anthropic.com
