...
owner: firecrawl
repo: firecrawl
path: examples/llama-4-maverick-web-extractor/README.md
url: https://github.com/firecrawl/firecrawl/blob/main/examples/llama-4-maverick-web-extractor/README.md
---
