...
<img className="block dark:hidden" src="/images/query_latency_1_0_10-light.png" alt="Query latency performance" />
<img className="hidden dark:block" src="/images/query_latency_1_0_10-dark.png" alt="Query latency performance" />

### Insert Latency

<img className="block dark:hidden" src="/images/insert_latency_1_0_10-light.png" alt="Insert latency performance" />
<img className="hidden dark:block" src="/images/insert_latency_1_0_10-dark.png" alt="Insert latency performance" />
...
<img className="block dark:hidden" src="/images/concurrent_writes_1_0_10-light.png" alt="Concurrent writes" />
<img className="hidden dark:block" src="/images/concurrent_writes_1_0_10-dark.png" alt="Concurrent writes" />

<img className="block dark:hidden" src="/images/concurrent_queries_1_0_10-light.png" alt="Concurrent queries" />
<img className="hidden dark:block" src="/images/concurrent_queries_1_0_10-dark.png" alt="Concurrent queries" />
...
<img className="block dark:hidden" src="/images/cpu_mean_query_latency_1_0_10-light.png" alt="CPU mean query latency" />
<img className="hidden dark:block" src="/images/cpu_mean_query_latency_1_0_10-dark.png" alt="CPU mean query latency" />
...
<img className="block dark:hidden" src="/images/concurrent_inserts_1_0_10-light.png" alt="Concurrent inserts" />
<img className="hidden dark:block" src="/images/concurrent_inserts_1_0_10-dark.png" alt="Concurrent inserts" />
