...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/overview/introduction.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/overview/introduction.mdx
---

---
title: "Introduction"
description: "Chroma is the open-source data infrastructure for AI. It comes with everything you need to get started built-in."
mode: "wide"
---
