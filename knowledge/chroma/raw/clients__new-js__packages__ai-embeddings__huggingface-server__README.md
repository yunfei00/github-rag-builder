...
owner: chroma-core
repo: chroma
path: clients/new-js/packages/ai-embeddings/huggingface-server/README.md
url: https://github.com/chroma-core/chroma/blob/main/clients/new-js/packages/ai-embeddings/huggingface-server/README.md
---
