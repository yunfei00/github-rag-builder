...
owner: chroma-core
repo: chroma
path: clients/new-js/packages/ai-embeddings/chroma-cloud-qwen/README.md
url: https://github.com/chroma-core/chroma/blob/main/clients/new-js/packages/ai-embeddings/chroma-cloud-qwen/README.md
---
