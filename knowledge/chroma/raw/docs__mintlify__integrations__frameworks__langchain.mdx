...
owner: chroma-core
repo: chroma
path: docs/mintlify/integrations/frameworks/langchain.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/integrations/frameworks/langchain.mdx
---
