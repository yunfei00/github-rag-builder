...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/collections/update-data.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/collections/update-data.mdx
---
---
title: "Update Data"
...
Metadata values can include arrays — see Adding Data for supported metadata types.
