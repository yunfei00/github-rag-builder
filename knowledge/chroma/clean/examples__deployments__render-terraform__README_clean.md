...
owner: chroma-core
repo: chroma
path: examples/deployments/render-terraform/README.md
url: https://github.com/chroma-core/chroma/blob/main/examples/deployments/render-terraform/README.md
---
...
export TF_VAR_render_api_token=
# Your Render.com user email
export TF_VAR_render_user_email=
