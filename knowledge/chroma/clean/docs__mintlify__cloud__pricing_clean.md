...
owner: chroma-core
repo: chroma
path: docs/mintlify/cloud/pricing.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/cloud/pricing.mdx
---
---
title: "Pricing"
---
...
- **$0.01 per document page extracted** — applies to document file types (PDF, Office documents, images, ebooks, HTML) that require conversion. See S3 Sync for the full list.
- **$0.01 per page scraped** — applies to web pages crawled during Web Sync.
