...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/overview/troubleshooting.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/overview/troubleshooting.mdx
---
---
title: "Troubleshooting"
description: "Common issues and solutions when working with Chroma."
---
...
2. If you are on a Linux system, you can install pysqlite3-binary, `pip install pysqlite3-binary` and then override the default
   sqlite3 library before running Chroma with the steps here.
   Alternatively you can compile SQLite from scratch and replace the library in your python installation with the latest version as documented here.
