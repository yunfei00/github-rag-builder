...
owner: chroma-core
repo: chroma
path: docs/mintlify/cloud/search-api/ranking.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/cloud/search-api/ranking.mdx
---
---
title: Ranking and Scoring
description: Learn how to use ranking expressions to score and order your search results. In Chroma, lower scores indicate better matches (distance-based scoring).
---
...
For advanced hybrid search combining multiple ranking strategies, consider using RRF (Reciprocal Rank Fusion) which is specifically designed for this purpose.
