...
owner: chroma-core
repo: chroma
path: docs/mintlify/reference/python/embedding-functions.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/reference/python/embedding-functions.mdx
---
---
