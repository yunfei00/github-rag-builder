...
owner: chroma-core
repo: chroma
path: docs/mintlify/cloud/search-api/batch-operations.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/cloud/search-api/batch-operations.mdx
---
---
title: Batch Operations
description: Execute multiple searches in a single API call for better performance and easier comparison of results.
---
...
- See practical examples of batch operations in production
- Learn about performance optimization for complex queries
- Explore migration guide for transitioning from legacy methods
