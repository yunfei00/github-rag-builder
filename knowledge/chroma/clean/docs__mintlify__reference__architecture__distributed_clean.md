...
owner: chroma-core
repo: chroma
path: docs/mintlify/reference/architecture/distributed.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/reference/architecture/distributed.mdx
---
---
