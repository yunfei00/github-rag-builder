...
owner: chroma-core
repo: chroma
path: docs/mintlify/integrations/frameworks/contextual-ai.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/integrations/frameworks/contextual-ai.mdx
---
---
title: Contextual AI
---
...
async function waitForJob(
  ...
  for (let attempt = 0; attempt  setTimeout(r, interval));
  }
}
