...
owner: chroma-core
repo: chroma
path: docs/mintlify/integrations/frameworks/anthropic-mcp.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/integrations/frameworks/anthropic-mcp.mdx
---
---
title: Anthropic MCP
---
