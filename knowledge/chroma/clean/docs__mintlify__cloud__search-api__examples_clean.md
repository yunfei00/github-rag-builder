...
owner: chroma-core
repo: chroma
path: docs/mintlify/cloud/search-api/examples.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/cloud/search-api/examples.mdx
---
---
title: Examples & Patterns
description: Complete end-to-end examples demonstrating real-world use cases of the Search API.
---
