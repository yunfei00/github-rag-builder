...
owner: chroma-core
repo: chroma
path: examples/chat_with_your_documents/README.md
url: https://github.com/chroma-core/chroma/blob/main/examples/chat_with_your_documents/README.md
---
...
You will need an OpenAI API key to run this demo. You can get one here.
