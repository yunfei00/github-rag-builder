...
owner: chroma-core
repo: chroma
path: examples/deployments/systemd-service/systemd-service.md
url: https://github.com/chroma-core/chroma/blob/main/examples/deployments/systemd-service/systemd-service.md
---
...
Alternatively you can copy the chroma-docker.service file
