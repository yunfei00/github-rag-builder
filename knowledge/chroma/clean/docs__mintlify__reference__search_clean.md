...
owner: chroma-core
repo: chroma
path: docs/mintlify/reference/search.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/reference/search.mdx
---
---
title: Search
...
dictionary references, see Where Filters.
