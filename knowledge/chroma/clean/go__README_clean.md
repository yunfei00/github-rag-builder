...
repo: chroma
path: go/README.md
url: https://github.com/chroma-core/chroma/blob/main/go/README.md
---
...
You can start by downloading the version of `protoc` from the release page. Ensure that you copy the `protoc` binary to `/usr/local/bin` or add it to your `GOPATH/bin`.
