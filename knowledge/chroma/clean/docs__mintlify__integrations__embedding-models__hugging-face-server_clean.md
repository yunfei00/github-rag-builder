...
owner: chroma-core
repo: chroma
path: docs/mintlify/integrations/embedding-models/hugging-face-server.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/integrations/embedding-models/hugging-face-server.mdx
---
---
