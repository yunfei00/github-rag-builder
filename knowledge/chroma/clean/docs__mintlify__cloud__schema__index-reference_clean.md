...
owner: chroma-core
repo: chroma
path: docs/mintlify/cloud/schema/index-reference.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/cloud/schema/index-reference.mdx
---
---
...
**Use Case**: Range and equality queries on float metadata (e.g., `where(K("price") 
