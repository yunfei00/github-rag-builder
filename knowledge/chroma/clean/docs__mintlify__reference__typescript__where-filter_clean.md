...
owner: chroma-core
repo: chroma
path: docs/mintlify/reference/typescript/where-filter.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/reference/typescript/where-filter.mdx
---
---
title: "Where Filters"
