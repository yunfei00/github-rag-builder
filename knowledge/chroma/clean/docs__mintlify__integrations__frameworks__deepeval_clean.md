...
owner: chroma-core
repo: chroma
path: docs/mintlify/integrations/frameworks/deepeval.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/integrations/frameworks/deepeval.mdx
---
---
title: DeepEval
---
