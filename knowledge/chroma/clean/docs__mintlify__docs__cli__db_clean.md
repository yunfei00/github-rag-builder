...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/cli/db.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/cli/db.mdx
---
---
title: "DB Management"
description: "Manage your Chroma Cloud databases using the CLI."
---
