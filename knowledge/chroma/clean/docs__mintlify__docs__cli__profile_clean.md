...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/cli/profile.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/cli/profile.mdx
---
---
title: "Profile Management"
description: "Manage CLI profiles for Chroma Cloud authentication."
---
