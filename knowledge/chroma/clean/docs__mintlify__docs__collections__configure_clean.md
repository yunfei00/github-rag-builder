...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/collections/configure.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/collections/configure.mdx
---
---
title: "Configure Collections"
description: "Learn how to configure Chroma collection index settings and embedding functions."
---
