...
owner: chroma-core
repo: chroma
path: docs/mintlify/cloud/package-search/mcp.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/cloud/package-search/mcp.mdx
---
---
title: Package Search MCP Server
sidebarTitle: MCP
---
	...
	mcpServers := []anthropic.BetaRequestMCPServerURLDefinitionParam{
		{
			URL:                "https://mcp.trychroma.com/package-search/v1",
			Name:               "package-search",
			AuthorizationToken: param.NewOpt(""),
...
Click "Get API Key" to create or log into your Chroma account and issue an API key for Package Search.
After issuing your API key, click the "Other" tab and copy your API key.
Get a Gemini API key in Google's AI Studio
