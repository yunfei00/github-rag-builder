...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/cli/copy.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/cli/copy.mdx
---
---
title: "Copy Collections"
description: "Copy collections between local Chroma and Chroma Cloud."
---
