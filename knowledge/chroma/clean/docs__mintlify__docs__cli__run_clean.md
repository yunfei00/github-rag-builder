...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/cli/run.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/cli/run.mdx
---
---
title: "Run a Chroma Server"
description: "Run a Chroma server locally using the CLI."
---
