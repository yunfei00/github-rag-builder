...
owner: chroma-core
repo: chroma
path: docs/mintlify/reference/js/client.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/reference/js/client.mdx
---
---
title: "Typescript Client"
url: "/reference/typescript"
---
