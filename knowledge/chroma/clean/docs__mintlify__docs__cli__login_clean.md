...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/cli/login.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/cli/login.mdx
---
---
title: "Login"
description: "Authenticate with Chroma Cloud using the CLI."
---
