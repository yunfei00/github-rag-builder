...
owner: chroma-core
repo: chroma
path: docs/mintlify/guides/deploy/docker.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/guides/deploy/docker.mdx
---
---
title: Docker
description: Run Chroma in a Docker Container
---
...
You can run a Chroma server in a Docker container, and access it using the `ChromaClient`. We provide images on both docker.com and ghcr.io.
...
You can run a Chroma server in a Docker container, and access it using the Rust `ChromaHttpClient`. We provide images on both docker.com and ghcr.io.
