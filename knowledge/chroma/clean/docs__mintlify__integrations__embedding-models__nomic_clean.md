...
owner: chroma-core
repo: chroma
path: docs/mintlify/integrations/embedding-models/nomic.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/integrations/embedding-models/nomic.mdx
---
---
title: Nomic
---
...
Visit Nomic documentation for more information on available models and task types.
