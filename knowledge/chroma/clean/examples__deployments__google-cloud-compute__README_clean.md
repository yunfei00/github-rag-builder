...
owner: chroma-core
repo: chroma
path: examples/deployments/google-cloud-compute/README.md
url: https://github.com/chroma-core/chroma/blob/main/examples/deployments/google-cloud-compute/README.md
---
...
```bash
export TF_VAR_project_id= #take note of this as it must be present in all of the subsequent steps
