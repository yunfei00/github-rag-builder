...
owner: chroma-core
repo: chroma
path: rust/chroma/README.md
url: https://github.com/chroma-core/chroma/blob/main/rust/chroma/README.md
---
# Chroma
...
1.  Get started with Chroma.  The easiest route is to sign up for Chroma Cloud.  If the cloud isn't yet your thing, `pip install chromadb` and `chroma run` will get you much of the same experience.
