...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/cli/browse.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/cli/browse.mdx
---
---
title: "Browse Collections"
description: "Inspect your Chroma collections with an in-terminal UI."
---
