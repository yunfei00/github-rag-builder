...
owner: chroma-core
repo: chroma
path: rust/wal3/README.md
url: https://github.com/chroma-core/chroma/blob/main/rust/wal3/README.md
---
wal3
====
...
impl LogWriter {
    pub async fn open(options: LogWriterOptions) -> Result, Error>;
    pub async fn append(self: &Arc, message: Message) -> Result;
}
...
impl LogReader {
    pub async fn open(options: LogReaderOptions) -> Result;
