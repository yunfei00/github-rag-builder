...
owner: chroma-core
repo: chroma
path: docs/mintlify/cloud/search-api/pagination-selection.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/cloud/search-api/pagination-selection.mdx
---
---
title: Pagination & Field Selection
description: Control how many results to return and which fields to include in your search results.
sidebarTitle: Pagination & Selection
---
