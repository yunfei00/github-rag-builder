...
owner: chroma-core
repo: chroma
path: docs/mintlify/guides/deploy/aws.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/guides/deploy/aws.mdx
---
---
title: AWS
description: Deploy Chroma on AWS using CloudFormation.
---
...
`8000`. Since you are running a Chroma server on AWS, our thin-client package may be enough for your application.
...
options.endpoint = "http://:8000".parse()?;
