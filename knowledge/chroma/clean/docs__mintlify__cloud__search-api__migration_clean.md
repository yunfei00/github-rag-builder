...
owner: chroma-core
repo: chroma
path: docs/mintlify/cloud/search-api/migration.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/cloud/search-api/migration.mdx
---
---
title: Migration Guide
description: Migrate from legacy `query()` and `get()` to the Search API.
---
