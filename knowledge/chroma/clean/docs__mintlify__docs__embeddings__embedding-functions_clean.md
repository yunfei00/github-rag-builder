...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/embeddings/embedding-functions.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/embeddings/embedding-functions.mdx
---
---
title: "Embedding Functions"
description: "Learn how to use embedding functions in Chroma to create vector representations of your data."
---
...
export class MyEmbeddingFunction implements EmbeddingFunction {
  ...
  validateConfigUpdate(config: Record) {
    if ("model" in config) {
