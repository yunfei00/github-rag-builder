...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/overview/migration.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/overview/migration.mdx
---
---
title: "Migration"
description: "Migration guides for Chroma version upgrades and schema changes."
---
...
_Either `_authn_credentials` or `authn_credentials_file` can be set, never both. Same for `authz_config` and `authz_config_file`. The value of the config (or data in the config file) will depend on your authn and authz providers. See here for more information._
