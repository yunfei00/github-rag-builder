...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/embeddings/multimodal.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/embeddings/multimodal.mdx
---
---
title: "Multimodal Embeddings"
description: "Learn how to work with multimodal data in Chroma collections."
---
