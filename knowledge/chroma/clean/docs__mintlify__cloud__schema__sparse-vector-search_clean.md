...
owner: chroma-core
repo: chroma
path: docs/mintlify/cloud/schema/sparse-vector-search.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/cloud/schema/sparse-vector-search.mdx
---
---
title: Sparse Vector Search Setup
description: Learn how to configure and use sparse vectors for keyword-based search, and combine them with dense embeddings for powerful hybrid search capabilities.
---
...
For comprehensive details on RRF parameters, weight tuning, and advanced hybrid search strategies, see the Search API Hybrid Search documentation.
