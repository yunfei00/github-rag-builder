...
owner: chroma-core
repo: chroma
path: docs/mintlify/docs/querying-collections/full-text-search.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/docs/querying-collections/full-text-search.mdx
---
---
