...
owner: chroma-core
repo: chroma
path: docs/mintlify/cloud/quotas-limits.mdx
url: https://github.com/chroma-core/chroma/blob/main/docs/mintlify/cloud/quotas-limits.mdx
---
---
title: Quotas & Limits
---
...
Most quotas can be increased upon request. If your application requires higher limits, please contact us.
...
For details about the fork edges limit and quota error handling when forking, see Collection Forking.
