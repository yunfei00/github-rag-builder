...
owner: microsoft
repo: autogen
path: docs/design/02 - Topics.md
url: https://github.com/microsoft/autogen/blob/main/docs/design/02%20-%20Topics.md
---
# Topics
...
These concepts intentionally map to the CloudEvents specification. This allows for easy integration with existing systems and tools.
...
- `type` - represents the type of event that occurs, this is static and defined in code
...
- `source` - represents where the event originated from, this is dynamic and based on the message itself
  - SHOULD be a URI
