...
owner: microsoft
repo: autogen
path: docs/dotnet/core/protobuf-message-types.md
url: https://github.com/microsoft/autogen/blob/main/docs/dotnet/core/protobuf-message-types.md
---
...
3. define your messages as specified in the Protocol Buffers Language Guide
