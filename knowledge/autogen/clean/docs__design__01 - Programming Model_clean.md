...
owner: microsoft
repo: autogen
path: docs/design/01 - Programming Model.md
url: https://github.com/microsoft/autogen/blob/main/docs/design/01%20-%20Programming%20Model.md
---
# Programming Model
...
Each event in the system is defined using the CloudEvents Specification. This allows for a common event format that can be used across different systems and languages. In CloudEvents, each event has "Context Attributes" that must include:
