...
owner: microsoft
repo: autogen
path: docs/dotnet/core/index.md
url: https://github.com/microsoft/autogen/blob/main/docs/dotnet/core/index.md
---
# AutoGen Core
...
You can obtain the SDK as a nuget package or by cloning the repository. The SDK is available on NuGet.
...
See Installation for more detailed notes on installing all the related packages. 

You can quickly get started by looking at the samples in the samples directory of the repository.
...
```csharp
public class MyAgent : BaseAgent, IHandle
{
    // ...
...
By overriding BaseAgent, you gain access to the runtime and logging utilities, and by implementing IHandle, you can easily define event-handling methods for your custom messages.
...
The Hello.AppHost project illustrates how to orchestrate a distributed system with multiple agents and the runtime in separate processes using .NET Aspire. It also points to a python agent that illustrates how to run agents in different languages in the same distributed system.
...
var client = builder.AddProject("HelloAgentsDotNET")
...
You can find more examples of how to use Aspire and XLang agents in the Microsoft.AutoGen.Integration.Tests.AppHost directory. 
...
A convenient way to define common event or message types to be used in both python and .NET agents is to define your events. This is covered here: Using Protocol Buffers to Define Message Types.
