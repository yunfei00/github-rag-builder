...
owner: microsoft
repo: autogen
path: python/packages/autogen-ext/src/autogen_ext/experimental/task_centric_memory/README.md
url: https://github.com/microsoft/autogen/blob/main/python/packages/autogen-ext/src/autogen_ext/experimental/task_centric_memory/README.md
---
# Task-Centric Memory
...
See the sample code for that and other forms of fast, memory-based learning.
