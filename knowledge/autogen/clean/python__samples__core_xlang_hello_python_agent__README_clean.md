...
owner: microsoft
repo: autogen
path: python/samples/core_xlang_hello_python_agent/README.md
url: https://github.com/microsoft/autogen/blob/main/python/samples/core_xlang_hello_python_agent/README.md
---
