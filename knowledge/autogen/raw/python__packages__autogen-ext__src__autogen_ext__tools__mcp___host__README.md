...
owner: microsoft
repo: autogen
path: python/packages/autogen-ext/src/autogen_ext/tools/mcp/_host/README.md
url: https://github.com/microsoft/autogen/blob/main/python/packages/autogen-ext/src/autogen_ext/tools/mcp/_host/README.md
---
