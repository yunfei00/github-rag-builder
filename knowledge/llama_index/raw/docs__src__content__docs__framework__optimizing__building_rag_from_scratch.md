...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/optimizing/building_rag_from_scratch.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/optimizing/building_rag_from_scratch.md
---
