...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/getting_started/discover_llamaindex.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/getting_started/discover_llamaindex.md
---

---
sidebar:
  order: 7
title: Discover LlamaIndex Video Series
---
