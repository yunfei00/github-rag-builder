...
<Aside type="tip">
  ...
  Model](/python/framework/module_guides/models/embeddings) - [Node Parser/Text
  Splitters](/python/framework/module_guides/loading/node_parsers) -
  [Callbacks](/python/framework/module_guides/observability/callbacks)
</Aside>
