...
<Aside type="tip">
  ...
  for a local [Sentence Transformers](https://sbert.net/) model in two lines:
...
See the [local starter tutorial](/python/framework/getting_started/starter_example_local) for a fully-local pipeline.
