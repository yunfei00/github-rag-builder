...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/optimizing/advanced_retrieval/advanced_retrieval.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/optimizing/advanced_retrieval/advanced_retrieval.md
---
