...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/understanding/extraction/lower_level.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/understanding/extraction/lower_level.md
---

---
sidebar:
  order: 4
title: Low-level structured data extraction
---
