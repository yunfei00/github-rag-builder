...
<Aside type="tip">
  ...
  documents](/python/framework/module_guides/loading/documents_and_nodes/usage_documents)
  and
  [nodes](/python/framework/module_guides/loading/documents_and_nodes/usage_nodes).
</Aside>
