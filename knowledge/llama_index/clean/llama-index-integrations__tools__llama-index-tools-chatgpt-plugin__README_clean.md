...
owner: run-llama
repo: llama_index
path: llama-index-integrations/tools/llama-index-tools-chatgpt-plugin/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/tools/llama-index-tools-chatgpt-plugin/README.md
---
# ChatGPT Plugin Tool
