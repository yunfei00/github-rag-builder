...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/understanding/rag/storing/index.mdx
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/understanding/rag/storing/index.mdx
---
---
title: Storing
---
...
```
  ...
  `embed_model`, etc., you will need to pass in the same options during
  `load_index_from_storage`, or have it set as the global
  settings.
...
```
  ...
  We have a more thorough example of using
  Chroma if you want to go
  deeper on this store.
