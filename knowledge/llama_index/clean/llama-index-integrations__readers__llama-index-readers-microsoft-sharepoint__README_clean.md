...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-microsoft-sharepoint/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-microsoft-sharepoint/README.md
---
...
loader = SharePointReader(
    ...
    tenant_id="",
    sharepoint_site_name="",
    sharepoint_host_name=".sharepoint.com",
    sharepoint_relative_url="/sites/",
