...
owner: run-llama
repo: llama_index
path: llama-index-integrations/tools/llama-index-tools-ionic-shopping/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/tools/llama-index-tools-ionic-shopping/README.md
---
...
ionic_tool = IonicShoppingToolSpec(api_key="").to_tool_list()
```
