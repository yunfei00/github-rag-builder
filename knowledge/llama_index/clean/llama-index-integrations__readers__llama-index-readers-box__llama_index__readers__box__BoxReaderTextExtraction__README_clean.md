...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-box/llama_index/readers/box/BoxReaderTextExtraction/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-box/llama_index/readers/box/BoxReaderTextExtraction/README.md
---
# Box Text Extraction
...
> [!TIP]
> For more information check the Box text representation documentation.
...
> [!TIP]
> Check out the Box Search for more information on how to operate search.
...
> [!TIP]
> Check out the Box Metadata Query Language for more information on how to construct queries.
