...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/module_guides/deploying/agents/tools.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/module_guides/deploying/agents/tools.md
---
---
title: Tools
---
...
def get_weather(
    location: Annotated[
        str, "A city name and state, formatted like ', '"
    ],
) -> str:
