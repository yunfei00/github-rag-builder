...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/getting_started/faq.mdx
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/getting_started/faq.mdx
---
---
sidebar:
  order: 8
