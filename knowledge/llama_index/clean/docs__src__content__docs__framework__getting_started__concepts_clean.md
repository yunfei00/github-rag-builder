...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/getting_started/concepts.mdx
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/getting_started/concepts.mdx
---
---
sidebar:
  order: 1
...
A chat engine is an end-to-end flow for having a conversation with your data (multiple back-and-forth instead of a single question-and-answer).
  ...
  * Tell me how to customize things *
  ...
  LlamaIndex guide * Ready to dig deep? Check
  out the component guides
