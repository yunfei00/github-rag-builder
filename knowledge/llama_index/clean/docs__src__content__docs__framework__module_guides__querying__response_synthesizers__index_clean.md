...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/module_guides/querying/response_synthesizers/index.mdx
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/module_guides/querying/response_synthesizers/index.mdx
---
---
...
When used in a query engine, the response synthesizer is used after nodes are retrieved from a retriever, and after any node-postprocessors are ran.
  ...
  Confused about where response synthesizer fits in the RAG workflow? Read the
  high-level concepts
...
```
  ...
  To learn how to build an index, see
  Indexing
