...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-chroma/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-chroma/README.md
---
...
reader = ChromaReader(
    collection_name="",
    persist_directory="",  # Optional: Directory where the collection is persisted
