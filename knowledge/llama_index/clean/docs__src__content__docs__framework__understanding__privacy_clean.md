...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/understanding/privacy.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/understanding/privacy.md
---
---
...
- Local starter tutorial: step-by-step walkthrough with Ollama + Hugging Face embeddings.
- Fully-local RAG cookbook (Chroma + Ollama): a persistent local pipeline with evaluation.
- Using local LLMs: list of local LLM integrations.
- Embeddings: local models, including ONNX / OpenVINO acceleration for CPU-only environments.
