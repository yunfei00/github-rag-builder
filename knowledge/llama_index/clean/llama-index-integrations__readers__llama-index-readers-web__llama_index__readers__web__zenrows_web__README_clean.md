...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-web/llama_index/readers/web/zenrows_web/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-web/llama_index/readers/web/zenrows_web/README.md
---
# ZenRows Web Reader

The ZenRows Web Reader allows you to scrape web pages using the ZenRows Universal Scraper API, which provides advanced features for bypassing anti-bot measures and extracting data from modern websites.
...
1. Sign up for a ZenRows account at https://app.zenrows.com/register
...
For complete API documentation, visit: https://docs.zenrows.com/universal-scraper-api/api-reference

## Support

- ZenRows Documentation: https://docs.zenrows.com/
- ZenRows Support: success@zenrows.com
