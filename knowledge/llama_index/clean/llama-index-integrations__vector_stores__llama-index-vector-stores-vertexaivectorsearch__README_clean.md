...
owner: run-llama
repo: llama_index
path: llama-index-integrations/vector_stores/llama-index-vector-stores-vertexaivectorsearch/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/vector_stores/llama-index-vector-stores-vertexaivectorsearch/README.md
---
...
- **v1.0 Usage**: See the v1 example notebook
- **v2.0 Usage**: See the v2 example notebook
- **v2.0 Migration**: See V2_MIGRATION.md for detailed migration guide
- **API Reference**: See the Google Cloud Documentation
