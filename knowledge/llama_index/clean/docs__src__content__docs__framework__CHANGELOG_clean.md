...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/CHANGELOG.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/CHANGELOG.md
---
---
title: ChangeLog
---
...
- Feat/async tool spec support (#20338)
- fix(vector_stores/lancedb): add missing '=3.9,=0.3.0 (#17120)
...
- Resolve nearly any huggingface embedding model using the `embed_model="local:"` syntax (#7255)
