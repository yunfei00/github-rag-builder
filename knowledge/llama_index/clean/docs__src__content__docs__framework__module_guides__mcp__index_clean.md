...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/module_guides/mcp/index.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/module_guides/mcp/index.md
---
---
...
- Use LlamaCloud APIs as MCP Tools/Servers
- Use any existing LlamaIndex workflow/tool as an MCP Tool/Server
