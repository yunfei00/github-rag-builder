...
owner: run-llama
repo: llama_index
path: llama-index-integrations/postprocessor/llama-index-postprocessor-nvidia-rerank/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/postprocessor/llama-index-postprocessor-nvidia-rerank/README.md
---
# LlamaIndex Postprocessor Integration: NVIDIA NIM Microservices

The `llama-index-postprocessor-nvidia-rerank` package contains LlamaIndex integrations for building applications with NVIDIA NIM microservices.
...
For details about each model, refer to Models.
