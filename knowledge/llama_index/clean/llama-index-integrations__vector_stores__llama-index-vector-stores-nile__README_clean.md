...
owner: run-llama
repo: llama_index
path: llama-index-integrations/vector_stores/llama-index-vector-stores-nile/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/vector_stores/llama-index-vector-stores-nile/README.md
---
# Nile Vector Store (PostgreSQL)

This integration makes it possible to use Nile - Postgres re-engineered for multi-tenant applications
...
- Example iPython / Jupyter notebook for Nile and LlamaIndex
