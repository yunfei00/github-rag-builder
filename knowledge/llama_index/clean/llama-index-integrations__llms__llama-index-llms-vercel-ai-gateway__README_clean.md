...
owner: run-llama
repo: llama_index
path: llama-index-integrations/llms/llama-index-llms-vercel-ai-gateway/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/llms/llama-index-llms-vercel-ai-gateway/README.md
---
...
You need to set either the environment variable `VERCEL_AI_GATEWAY_API_KEY`, `VERCEL_OIDC_TOKEN`, or pass your API key directly in the class constructor. Replace `` with your actual API key:
