...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-faiss/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-faiss/README.md
---
...
documents = reader.load_data(
    query="",  # 2D numpy array of query vectors
    id_to_text_map={"": ""},  # A map from IDs to text
