...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-preprocess/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-preprocess/README.md
---
# Preprocess Loader
...
When initializing `PreprocessReader`, you should pass your `API Key`, if you don't have it yet, please ask for one at support@preprocess.co. Without an `API Key`, the loader will raise an error.
...
`PreprocessReader` is based on `pypreprocess` from Preprocess library.
