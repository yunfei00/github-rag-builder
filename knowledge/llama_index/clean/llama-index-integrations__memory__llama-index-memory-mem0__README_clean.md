...
owner: run-llama
repo: llama_index
path: llama-index-integrations/memory/llama-index-memory-mem0/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/memory/llama-index-memory-mem0/README.md
---
...
1. Set your Mem0 Platform API key as an environment variable. You can replace `` with your actual API key:
