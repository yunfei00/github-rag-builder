...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-database/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-database/README.md
---
...
reader = DatabaseReader(
    sql_database="",  # Optional: SQLDatabase object
    engine="",  # Optional: SQLAlchemy Engine object
...
documents = reader.load_data(
    query=""  # SQL query parameter to filter tables and rows
)
```
