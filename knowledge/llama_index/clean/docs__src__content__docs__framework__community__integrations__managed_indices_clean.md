...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/community/integrations/managed_indices.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/community/integrations/managed_indices.md
---
---
...
First, sign up and use the Vectara Console to create a corpus (aka Index), and add an API key for access.
