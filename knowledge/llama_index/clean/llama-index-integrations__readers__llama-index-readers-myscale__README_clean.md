...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-myscale/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-myscale/README.md
---
...
reader = MyScaleReader(
    myscale_host="",  # MyScale host address
    username="",  # Username to login
    password="",  # Password to login
    database="",  # Database name (default: 'default')
    table="",  # Table name (default: 'llama_index')
    index_type="",  # Index type (default: "IVFLAT")
    metric="",  # Metric to compute distance (default: 'cosine')
...
documents = reader.load_data(
    ...
    where_str="",  # Where condition string (default: None)
