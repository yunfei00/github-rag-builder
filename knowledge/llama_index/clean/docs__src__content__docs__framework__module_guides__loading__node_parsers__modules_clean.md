...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/module_guides/loading/node_parsers/modules.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/module_guides/loading/node_parsers/modules.md
---
---
...
The `Chunker` is a multi purpose node parser that wraps around the chonkie chunkers.
