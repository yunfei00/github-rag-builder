...
owner: run-llama
repo: llama_index
path: llama-index-integrations/embeddings/llama-index-embeddings-deepinfra/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/embeddings/llama-index-embeddings-deepinfra/README.md
---
...
Here is the link to the embeddings models.

First, you need to sign up on the Deepinfra website and get the API token.
