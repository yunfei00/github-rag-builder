...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/llms.txt
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/llms.txt
---
# LlamaIndex
...
1. **Loading**: Getting your data from where it lives - whether it's text files, PDFs, another website, a database, or an API - into your workflow. LlamaHub provides hundreds of connectors to choose from.
...
1. **Installation**: Install LlamaIndex using pip or your preferred package manager
2. **Basic Agent Example**: Create a simple agent that can perform basic tasks using tools
3. **Adding RAG Capabilities**: Enhance your agent with the ability to search through documents
4. **Advanced Features**: Explore workflows, multi-agent systems, and production deployment
