...
owner: run-llama
repo: llama_index
path: docs/examples/finetuning/eval_questions.txt
url: https://github.com/run-llama/llama_index/blob/main/docs/examples/finetuning/eval_questions.txt
---
...
What are the projected surface warming thresholds that exceed 2°C in the CMIP6 models for the end of the century in different Shared Socioeconomic Pathways (SSPs)?
