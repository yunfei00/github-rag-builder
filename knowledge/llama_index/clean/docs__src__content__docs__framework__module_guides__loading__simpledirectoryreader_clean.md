...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/module_guides/loading/simpledirectoryreader.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/module_guides/loading/simpledirectoryreader.md
---
---
...
This can be any filesystem object that is implemented by the `fsspec` protocol.
The `fsspec` protocol has open-source implementations for a variety of remote filesystems including AWS S3, Azure Blob & DataLake, Google Drive, SFTP, and many others.
