...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-jira/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-jira/README.md
---
# JIRA Reader
...
documents = reader.load_data(query="project = ")
```
