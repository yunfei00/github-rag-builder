...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-web/llama_index/readers/web/olostep_web/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-web/llama_index/readers/web/olostep_web/README.md
---
# Olostep Web Loader

This loader fetches content from a URL using the Olostep API. The loader can be used in two modes: `scrape` and `search`.
...
You also need an API key from Olostep.
