...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/module_guides/storing/chat_stores.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/module_guides/storing/chat_stores.md
---
---
title: Chat Stores
---
...
print(chat_store.get_messages("123"))
# >>> [ChatMessage(role=, content='Who are you?', additional_kwargs={}),
#      ChatMessage(role=, content='I am your helpful AI assistant.', additional_kwargs={})]]
...
# >>> [ChatMessage(role=, content='Who are you?', additional_kwargs={}),
#      ChatMessage(role=, content='I am your helpful AI assistant.', additional_kwargs={})],
#      ChatMessage(role=, content='What can you do?', additional_kwargs={})]
```
