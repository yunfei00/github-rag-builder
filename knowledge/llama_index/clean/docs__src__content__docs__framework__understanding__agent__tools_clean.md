...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/understanding/agent/tools.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/understanding/agent/tools.md
---
---
sidebar:
  order: 2
...
We love open source contributions of new tools! You can see an example of what the code of the Yahoo finance tool looks like:
