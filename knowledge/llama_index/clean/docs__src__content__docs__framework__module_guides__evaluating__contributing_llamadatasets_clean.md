...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/module_guides/evaluating/contributing_llamadatasets.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/module_guides/evaluating/contributing_llamadatasets.md
---
---
...
why we launched `LlamaDatasets` in llama-hub. In this page,
...
json file and the source text files to our llama-datasets repository. Additionally, you'll have to make
a pull request, to upload required metadata of the dataset to our llama-hub repository.
