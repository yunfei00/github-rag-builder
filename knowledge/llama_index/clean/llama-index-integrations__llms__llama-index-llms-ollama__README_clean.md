...
owner: run-llama
repo: llama_index
path: llama-index-integrations/llms/llama-index-llms-ollama/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/llms/llama-index-llms-ollama/README.md
---
...
5. If you set `llm = Ollama(..., model="")` without a version, it will automatically look for the latest version.
