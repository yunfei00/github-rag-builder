...
owner: run-llama
repo: llama_index
path: docs/src/content/docs/framework/use_cases/q_and_a.md
url: https://github.com/run-llama/llama_index/blob/main/docs/src/content/docs/framework/use_cases/q_and_a.md
---
---
...
**I want to run without sending data to a hosted API**: See the privacy guide and the local starter tutorial. Both walk through an OSS stack using Hugging Face embeddings, reranker, and a local LLM runtime like Ollama.
