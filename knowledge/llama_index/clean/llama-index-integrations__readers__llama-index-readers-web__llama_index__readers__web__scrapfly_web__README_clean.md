...
owner: run-llama
repo: llama_index
path: llama-index-integrations/readers/llama-index-readers-web/llama_index/readers/web/scrapfly_web/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/readers/llama-index-readers-web/llama_index/readers/web/scrapfly_web/README.md
---
# ScrapFly Web Loader
...
2. **API Key**: Register for free from scrapfly.io/register to obtain your API key.
...
See the ScrapFly documentation for the full details on using the ScrapeConfig.
