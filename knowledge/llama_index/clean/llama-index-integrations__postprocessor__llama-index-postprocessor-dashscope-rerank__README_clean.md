...
owner: run-llama
repo: llama_index
path: llama-index-integrations/postprocessor/llama-index-postprocessor-dashscope-rerank/README.md
url: https://github.com/run-llama/llama_index/blob/main/llama-index-integrations/postprocessor/llama-index-postprocessor-dashscope-rerank/README.md
---
...
results = dashscope_rerank.postprocess_nodes(nodes, query_str="")
for res in results:
