...
url: https://github.com/langgenius/dify/blob/main/docs/ja-JP/CONTRIBUTING.md
---
# 貢献ガイド
...
ライセンスについては、ライセンスと貢献者同意書をご一読ください。また、コミュニティは行動規範に従っています。

## 始める前に

取り組むべき課題をお探しですか？初心者向けの課題から選んで始めてみましょう！

新しいモデルランタイムやツールを追加したいですか？プラグインリポジトリでPRを作成し、あなたの成果を見せてください。

既存のモデルランタイムやツールの更新、バグ修正をしたいですか？公式プラグインリポジトリで作業を進めてください。
...
フロントエンドサービスのセットアップについては、`web/README.md`のガイドを参照してください。このドキュメントには、フロントエンド環境を適切にセットアップするための詳細な手順が記載されています。

#### バックエンド

バックエンドサービスのセットアップについては、`api/README.md`の手順を参照してください。このドキュメントには、バックエンドを正しく動作させるためのステップバイステップのガイドが含まれています。
...
貢献中に行き詰まったり、緊急の質問がある場合は、関連するGitHubイシューで質問するか、Discordで気軽にチャットしてください。
