...
owner: langgenius
repo: dify
path: docs/design/human-in-the-loop/hitl-form-file-upload-design.md
url: https://github.com/langgenius/dify/blob/main/docs/design/human-in-the-loop/hitl-form-file-upload-design.md
---
