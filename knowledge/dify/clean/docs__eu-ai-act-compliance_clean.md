...
owner: langgenius
repo: dify
path: docs/eu-ai-act-compliance.md
url: https://github.com/langgenius/dify/blob/main/docs/eu-ai-act-compliance.md
---
...
- **Article 50** (end-user transparency) still applies if users interact with your application directly. See the Article 50 section below.
- **GDPR** still applies if you process personal data. See the GDPR section below.
