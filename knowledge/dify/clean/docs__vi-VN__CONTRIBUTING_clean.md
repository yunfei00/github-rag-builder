...
owner: langgenius
repo: dify
path: docs/vi-VN/CONTRIBUTING.md
url: https://github.com/langgenius/dify/blob/main/docs/vi-VN/CONTRIBUTING.md
---
# ĐÓNG GÓP
...
Về giấy phép, vui lòng dành chút thời gian đọc Thỏa thuận Cấp phép và Người đóng góp ngắn gọn của chúng tôi. Cộng đồng cũng tuân theo quy tắc ứng xử.

## Trước khi bắt đầu

Đang tìm việc để thực hiện? Hãy xem qua các issue dành cho người mới và chọn một để bắt đầu!

Bạn có một model runtime hoặc công cụ mới thú vị để thêm vào? Mở PR trong repo plugin của chúng tôi và cho chúng tôi thấy những gì bạn đã xây dựng.

Cần cập nhật model runtime, công cụ hiện có hoặc sửa lỗi? Ghé thăm repo plugin chính thức và thực hiện phép màu của bạn!
...
| Yêu cầu tính năng phổ biến từ bảng phản hồi cộng đồng | Ưu tiên trung bình |
...
1. Vui lòng liên kết issue trong mô tả PR, `fixes #`
1. Được merge!
...
Để thiết lập dịch vụ frontend, vui lòng tham khảo hướng dẫn chi tiết của chúng tôi trong file `web/README.md`. Tài liệu này cung cấp hướng dẫn chi tiết để giúp bạn thiết lập môi trường frontend một cách đúng đắn.

#### Backend

Để thiết lập dịch vụ backend, vui lòng tham khảo hướng dẫn chi tiết của chúng tôi trong file `api/README.md`. Tài liệu này chứa hướng dẫn từng bước để giúp bạn khởi chạy backend một cách suôn sẻ.
...
Nếu bạn bị mắc kẹt hoặc có câu hỏi cấp bách trong quá trình đóng góp, chỉ cần gửi câu hỏi của bạn thông qua issue GitHub liên quan, hoặc tham gia Discord của chúng tôi để trò chuyện nhanh.
