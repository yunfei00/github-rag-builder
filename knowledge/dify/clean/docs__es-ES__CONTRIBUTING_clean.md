...
owner: langgenius
repo: dify
path: docs/es-ES/CONTRIBUTING.md
url: https://github.com/langgenius/dify/blob/main/docs/es-ES/CONTRIBUTING.md
---
# CONTRIBUIR
...
En términos de licencia, por favor tómate un minuto para leer nuestro breve Acuerdo de Licencia y Colaborador. La comunidad también se adhiere al código de conducta.

## Antes de empezar

¿Buscas algo en lo que trabajar? Explora nuestros buenos primeros issues y elige uno para comenzar.

¿Tienes un nuevo modelo o herramienta genial para añadir? Abre un PR en nuestro repositorio de plugins y muéstranos lo que has construido.

¿Necesitas actualizar un modelo existente, herramienta o corregir algunos errores? Dirígete a nuestro repositorio oficial de plugins y haz tu magia.
...
| Solicitudes populares de funcionalidades de nuestro tablero de comentarios de la comunidad | Prioridad Media |
...
1. Por favor vincula el issue en la descripción del PR, `fixes #`
1. ¡Fusiona tu código!
...
Para configurar el servicio frontend, por favor consulta nuestra guía completa en el archivo `web/README.md`. Este documento proporciona instrucciones detalladas para ayudarte a configurar el entorno frontend correctamente.

#### Backend

Para configurar el servicio backend, por favor consulta nuestras instrucciones detalladas en el archivo `api/README.md`. Este documento contiene una guía paso a paso para ayudarte a poner en marcha el backend sin problemas.
...
Si alguna vez te quedas atascado o tienes una pregunta urgente mientras contribuyes, simplemente envíanos tus consultas a través del issue relacionado de GitHub, o únete a nuestro Discord para una charla rápida.
