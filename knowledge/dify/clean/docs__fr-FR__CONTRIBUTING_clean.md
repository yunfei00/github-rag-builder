...
url: https://github.com/langgenius/dify/blob/main/docs/fr-FR/CONTRIBUTING.md
---
# CONTRIBUER
...
En termes de licence, veuillez prendre une minute pour lire notre bref Accord de Licence et de Contributeur. La communauté adhère également au code de conduite.

## Avant de vous lancer

Vous cherchez quelque chose à réaliser ? Parcourez nos problèmes pour débutants et choisissez-en un pour commencer !

Vous avez un nouveau modèle ou un nouvel outil à ajouter ? Ouvrez une PR dans notre dépôt de plugins et montrez-nous ce que vous avez créé.

Vous devez mettre à jour un modèle existant, un outil ou corriger des bugs ? Rendez-vous sur notre dépôt officiel de plugins et faites votre magie !
...
| Demandes populaires de fonctionnalités de notre tableau de feedback communautaire | Priorité Moyenne |
...
1. Veuillez lier le problème dans la description de la PR, `fixes #`
...
Pour configurer le service frontend, veuillez consulter notre guide complet dans le fichier `web/README.md`. Ce document fournit des instructions détaillées pour vous aider à configurer correctement l'environnement frontend.

#### Backend

Pour configurer le service backend, veuillez consulter nos instructions détaillées dans le fichier `api/README.md`. Ce document contient un guide étape par étape pour vous aider à faire fonctionner le backend sans problème.
...
Si jamais vous êtes bloqué ou avez une question urgente en contribuant, envoyez-nous simplement vos questions via le problème GitHub concerné, ou rejoignez notre Discord pour une discussion rapide.
