...
owner: langgenius
repo: dify
path: api/providers/vdb/README.md
url: https://github.com/langgenius/dify/blob/main/api/providers/vdb/README.md
---
# VDB providers
...
2. **Each provider** (`api/providers/vdb//`) implements those contracts and registers an entry point.
...
- `api/providers/vdb//pyproject.toml` — project name `dify-vdb-`, dependencies, entry points.
- `api/providers/vdb//src/dify_vdb_/` — implementation (e.g. `PGVector`, `PGVectorFactory`).
