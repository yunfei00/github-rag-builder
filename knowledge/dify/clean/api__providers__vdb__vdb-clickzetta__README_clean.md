...
owner: langgenius
repo: dify
path: api/providers/vdb/vdb-clickzetta/README.md
url: https://github.com/langgenius/dify/blob/main/api/providers/vdb/vdb-clickzetta/README.md
---
...
CREATE TABLE  (
    ...
    metadata JSON,
    vector VECTOR(FLOAT, ) NOT NULL,
    PRIMARY KEY (id)
);

-- Vector index for similarity search
CREATE VECTOR INDEX idx__vec
ON TABLE .(vector) 
PROPERTIES (
...
CREATE INVERTED INDEX idx__text
ON .(content)
PROPERTIES (
    "analyzer" = "chinese",
    "mode" = "smart"
...
- Clickzetta Vector Search Documentation
- Clickzetta Inverted Index Documentation
- Clickzetta SQL Functions
